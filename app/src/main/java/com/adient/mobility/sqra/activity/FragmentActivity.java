...
//        global.jsonResult = MySingleTon.json;
        ...
        Gson gson = new Gson();
        Map<String, Map<String, Map<String, Map<String, String>>>> sqrcMap = (Map<String, Map<String, Map<String, Map<String, String>>>>) gson.fromJson(MySingleTon.json, region.getClass());
